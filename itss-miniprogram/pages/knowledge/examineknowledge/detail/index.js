...
Page({
    ...
    remark: function(e){
     ...
     onOpenpopup(){
        ...
        wx.request({
            url: app.globalData.address + 'knowledge/toExamineKnowledge.do',
            method: 'POST',
            header: {
              "Authorization":wx.getStorageSync('tokenValue'),
            ...
            data: {
              "id": that.data.id,
              "approval_opinions": that.data.remark,
     ...
     getRefuse(){
        ...
        wx.request({
            url: app.globalData.address + 'knowledge/toRefuseExamineKnowledge.do',
            method: 'POST',
            header: {
              "Authorization":wx.getStorageSync('tokenValue'),
              "Content-Type": "application/json"
