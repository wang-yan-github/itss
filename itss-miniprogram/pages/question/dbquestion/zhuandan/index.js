    ...
    wx.request({
      ...
      success: function (res) {
        ...
        that.data.steps.push({
          text: "开单",
          desc: obj.processTime == null ? "" : obj.appraisal_time
        });
        that.data.steps.push({
          text: "鉴定",
          desc: obj.create_time == null ? "" : obj.create_time
        });
        that.data.steps.push({
          text: "解决 ",
          desc: obj.pauseTime == null ? "" : obj.solve_time
        });
        that.data.steps.push({
          text: "审核",
          desc: obj.processTime == null ? "" : obj.update_time
        });
        that.data.steps.push({
          text: "关单",
          desc: obj.processTime == null ? "" : obj.clearance_time
        });
