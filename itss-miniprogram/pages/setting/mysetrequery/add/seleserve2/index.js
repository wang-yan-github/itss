...
Page({
  ...
  itemonchange(event) {
    ...
    first_ids.splice(0, 1);
    first_value.splice(0, 1);
  ...
  page: function (val) {
    ...
    wx.request({
      url: app.globalData.address + 'assetsManage/changeList.do',
      method: 'POST',
      header: {
  ...
  onClosepopup: function (val) {
    ...
    wx.setStorageSync('changeList2', this.data.first_value);
    console.log(wx.getStorageSync('changeList2'))
