...
Page({
    ...
    page: function (val) {
      ...
      let params = {
        ...
        // "status": '4,5,6',
        "assets_name": that.data.queryForm.keyword,
      };
      console.log("that.data.pageIndex: " , that.data.pageIndex)
      console.log("配置项list查询: ", params)
      wx.request({
        url: app.globalData.address + 'assetsManage/assetsManageList.do',
        method: 'POST',
        header: {
    ...
    onClosepopup: function (val) {
      ...
      wx.setStorageSync('changeList3', this.data.first_value);
      console.log(wx.getStorageSync('changeList3'))
