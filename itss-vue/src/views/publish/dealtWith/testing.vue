<template>
  <div class="main-container pb80">
    <el-form ref="form" label-width="100px">
      ...
      <div class="bottom">
        <el-button type="primary" size="medium" @click="testPublish">
          完成
        </el-button>
      </div>
    </el-form>
...
import {testPublish, getPublishBasic,getLogInfo,getApprovalByPublishId} from "@/api/publish";
...
export default {
  ...
  methods: {
    ...
    async testPublish() {
      ...
      const {data} = await testPublish(params)
