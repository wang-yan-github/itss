                ...
                <div class="box_content">
                  ...
                  <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                    <el-form-item label="部门" prop="department_name">
                      <el-input v-model.trim="form.department_name" clearable autocomplete="off" placeholder="请选择" @clear="form.dw_id=''" style="width: 80%;" @click.native="openwinOne"></el-input>
                  ...
                  <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                    <el-form-item label="需变更内容" prop="content">
                      <el-input v-model.trim="form.content" autocomplete="off" placeholder='请输入' type="textarea" :rows="3"></el-input>
                    </el-form-item>
                  </el-col>
<!--                  <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">-->
<!--                    <el-form-item label="处理结果" prop="result">-->
<!--                      <el-input v-model.trim="form.result" autocomplete="off" placeholder='请输入' type="textarea" :rows="3"></el-input>-->
<!--                    </el-form-item>-->
<!--                  </el-col>-->
                  <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                    <el-form-item label="关联的变更" prop="relevance_NO">
                      <el-input v-model.trim="form.relevance_name" autocomplete="off" placeholder="请选择" style="width: 80%;" clearable @clear="form.relevance_NO=''" @click.native="openwinChange"></el-input>
                      <el-button icon="el-icon-search" style="border-left: 0; background-color: #f5f7fa; height: 32px; width: 20%" @click="openwinChange"></el-button>
                    </el-form-item>
                  </el-col>
                  </div></div>
                </el-card>
          ...
          <el-tab-pane :label="assetsName" name="second">
            <el-card class="cardbox" shadow="never" style="border-top: 0">
            <el-table ref="listTable" border stripe :data="tableDataSet" highlight-current-row @selection-change="setSelectRowsSet">
              <el-table-column show-overflow-tooltip type="selection" align="center"></el-table-column>
              <el-table-column show-overflow-tooltip prop="assets_number" label="资产编号" align="center" header-align="center"></el-table-column>
              <el-table-column show-overflow-tooltip prop="assets_name" label="资产名称" align="center" header-align="center"></el-table-column>
              <el-table-column show-overflow-tooltip prop="assetsTypeName" label="配置项类型" align="center" width="130px;"></el-table-column>
              <el-table-column show-overflow-tooltip prop="childAssetName" label="配置子类" align="center" width="130px;"></el-table-column>
              <el-table-column show-overflow-tooltip prop="deptName" label="部门" width="100px;" align="center"></el-table-column>
              <el-table-column show-overflow-tooltip prop="receiverName" label="领用人" width="100px;" align="center"></el-table-column>
              <el-table-column show-overflow-tooltip prop="purchaseCompanyName" label="购置公司" width="120px;" align="center"></el-table-column>
              <el-table-column show-overflow-tooltip prop="is_secrecy" label="保密" width="100px;" align="center">
              ...
              <el-table-column show-overflow-tooltip prop="assetsStatusName" label="资产状态" width="100px;" align="center">
                <template #default="scope">
              ...
              <el-table-column show-overflow-tooltip prop="itStatusName" label="IT状态" width="100px;" align="center">
                <template #default="scope">
                  <el-tag size="mini" icon="el-icon-delete" class="red" type="success">
                    {{ scope.row.itStatusName }}
                  </el-tag>
                </template>
              </el-table-column>
            </el-table>
            <div class="btn-box" style="margin-top: 10px;">
              <el-button type="danger" icon="el-icon-delete" @click="handleDeletepz">移除选择对象</el-button>
              <el-button type="primary" icon="el-icon-plus" @click="handleAddPz">添加</el-button>
            </div>
          </el-card>
          </el-tab-pane>
          <el-tab-pane :label="eventsName" name="three">
            <el-card class="cardbox" shadow="never" style="border-top: 0">
            <el-table ref="listTable" border stripe :data="tableDataEvent" highlight-current-row @selection-change="setSelectRowsEvent">
              <el-table-column show-overflow-tooltip type="selection" align="center"></el-table-column>
              ...
              <el-table-column show-overflow-tooltip prop="ex_solve_time" align="center" label="解决时间" width="160px;"></el-table-column>
            ...
            <div class="btn-box" style="margin-top: 10px;">
              <el-button type="danger" icon="el-icon-delete" @click="handleDeleteEvent">移除选择对象</el-button>
              <el-button type="primary" icon="el-icon-plus" @click="handleAddGd">添加</el-button>
            </div>
          </el-card>
          </el-tab-pane>
    ...
    <div class="bottom">
      <el-button type="primary" size="medium" @click="saveok" :disabled="disabled">保存</el-button>
...
<script>
  import {toList, getAllAssetsRequestConfig, toAdd} from '@/api/assetsconfigreq'
  ...
  export default {
    ...
    created() {
      ...
      this.eventCreateChange();//关联的工单
    },
    methods: {
      async fetchData() {
        const {data} = await getCurrentLoginUserInfo();
        this.form.dw_id = data.department_id;
        this.form.department_name = data.departmentName;
      ...
      handleAddGd() {
        ...
        this.$refs['dialoggd'].showWin(null,this.tableDataEvent)
      },
      ...
      saveok() {
        ...
        this.$refs['form'].validate(async (valid) => {
          if (valid) {
            ...
            const {msg} = await toAdd(this.form)
