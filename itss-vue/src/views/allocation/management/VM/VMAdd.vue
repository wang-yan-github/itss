                ...
                <el-card class="cardbox" shadow="hover">
                  ...
                  <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                    <el-form-item label="OS许可证">
                      ...
                      >
                        <el-option
                          v-for="item in assetsOsLicenceList"
                          :key="item.id"
                  ...
                  <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                    <el-form-item label="内存" prop="data1">
                      <el-input
...
import { getList } from '@/api/assetsOs'
import { getAssetsOsLicenceList } from '@/api/assetsOsLicence'
...
export default {
  ...
  methods: {
    ...
    getAssetsOs() {
      getList().then((res) => {
        if (res.code == 0) {
          this.OSList = res.data.list
        }
      })
    },
    /*--获取OS许可证--*/
    getAssetsOsLicence() {
      getAssetsOsLicenceList().then((res) => {
        if (res.code == 0) {
          this.assetsOsLicenceList = res.data.list
        }
      })
    },
    //---------------获取下拉框选项end-----------------------------
