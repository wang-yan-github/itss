                ...
                <el-card class="cardbox" shadow="hover">
                  ...
                  <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                    <el-form-item label="系统安装时间" prop="data1">
                      <el-date-picker
                        v-model="queryForm.os_install_time"
                        type="date"
                        placeholder="选择日期"
                        style="width: 100%"
                      ></el-date-picker>
                  ...
                  <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                    <el-form-item label="硬盘序列号">
                      <el-input
                        v-model.trim="queryForm.harddisk_serial"
                        placeholder="请输入"
                        autocomplete="off"
                      ></el-input>
                    </el-form-item>
                  ...
                  <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                    <el-form-item label="无线IP地址">
                      <el-input
                        v-model.trim="queryForm.wireless_ip"
                        placeholder="请输入"
                        autocomplete="off"
                      ></el-input>
                    </el-form-item>
                  ...
                  <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                    <el-form-item label="无线MAC地址">
                      <el-input
                        v-model.trim="queryForm.wireless_mac"
                        placeholder="请输入"
                        autocomplete="off"
                      ></el-input>
                    </el-form-item>
...
export default {
  ...
  mounted() {
    ...
    this.getData()
    this.assetsTypeChange(this.$route.query.id);
    this.getAssetsTypes();
    //this.getFields()
  },
  methods: {
