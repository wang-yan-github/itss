                ...
                <el-row :gutter="20">
                  ...
                  <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                    <div class="box_card">
                      ...
                      <div class="box_content">
                        <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                          <el-form-item label="软件许可证:" class="tsitem">
                            {{ queryForm.software_licence_name }}
                          </el-form-item>
                        </el-col>
                        <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                          <el-form-item label="路径:" class="tsitem">
                            {{ queryForm.path }}
                          </el-form-item>
                        </el-col>
                        <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                          <el-form-item label="版本:" class="tsitem">
                            {{ queryForm.edition }}
                          </el-form-item>
                        </el-col>
            ...
            <div class="box_card">
              ...
              <div class="box_content">
                <el-form-item label="" class="mb0">
                  <el-image :src="queryForm.qrCode" style="width: 140px; height: 140px"></el-image>
                </el-form-item>
