<template>
  <div class="index-container pb80">
    <el-form ref="form" :model="queryForm" label-width="140px" :rules="rules">
      <template>
                ...
                <el-card class="cardbox" shadow="hover">
                  ...
                  <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                    <el-form-item label="品牌">
                      <el-select v-model.trim="queryForm.brand_id" class="w">
                        <el-option
                  ...
                  <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                    <el-form-item label="维保结束日期" prop="data1">
                      <el-date-picker
                  ...
                  <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                    <el-form-item label="机柜">
                      <el-select
                        v-model.trim="queryForm.cabinet_id"
                        class="w"
                  ...
                  <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                    <el-form-item label="起始机位">
                      <el-select v-model.trim="queryForm.start_seat" class="w">
                        <el-option
                          v-for="item in seats"
                          :key="item.id"
                          :label="item.assets_name"
                  ...
                  <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                    <el-form-item label="终止机位">
                      <el-select v-model.trim="queryForm.end_seat" class="w">
                        <el-option
                          v-for="item in seats"
                          :key="item.id"
                          :label="item.assets_name"
                  ...
                  <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                    <el-form-item label="IP地址2">
                      <el-input
                        v-model.trim="queryForm.ip2"
                        placeholder="请输入"
                        autocomplete="off"
                      ></el-input>
                    </el-form-item>
                  ...
                  <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                    <el-form-item label="MAC地址3">
                      <el-input
                        v-model.trim="queryForm.mac3"
                        placeholder="请输入"
                        autocomplete="off"
                      ></el-input>
                    </el-form-item>
                  ...
                  <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                    <el-form-item label="硬盘">
                      <el-input
                        v-model.trim="queryForm.hard_disk"
                        placeholder="请输入"
                        autocomplete="off"
                      ></el-input>
                    </el-form-item>
                  ...
                  <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                    <el-form-item label="服务器配置">
                      <el-input
                        v-model.trim="queryForm.server_config"
                        placeholder="请输入"
                        autocomplete="off"
                      ></el-input>
                    </el-form-item>
                  ...
                  <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                    <el-form-item label="是否纳入虚拟化资源池">
                      <el-select
                        v-model.trim="queryForm.is_invirtual"
                        class="w"
                      >
                        <el-option label="是" :value="1"></el-option>
                        <el-option label="否" :value="0"></el-option>
                  ...
                  <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                    <el-form-item label="服务编号/快速服务代码">
                      <el-input
                        v-model.trim="queryForm.server_code"
                        placeholder="请输入"
                        autocomplete="off"
                      ></el-input>
                    </el-form-item>
                  ...
                  <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                    <el-form-item label="OS许可证">
                      <el-select
                        v-model.trim="queryForm.os_licence_id"
                        class="w"
                      >
                        <el-option
                          v-for="item in osLicenceList"
                          :key="item.id"
    ...
    ></dialogfive>
    <div class="bottom">
      <el-button type="primary" size="medium" @click="saveok">
        保存并继续
      </el-button>
...
import { getAllOsLicence } from '@/api/assetsOsLicence'
...
import { getAssetsByType,getSeats} from '@/api/assetsManage'
export default {
  name: 'serverEdit',
  ...
  mounted() {
    this.queryForm.manage_id = this.$route.query.id
    this.getData()
  ...
  methods: {
    ...
    /*--获取OS许可证--*/
    getOsLicence() {
      getAllOsLicence().then((res) => {
        if (res.code == 0) {
          this.osLicenceList = res.data
        }
      })
    },
    /*--获取机柜信息--*/
    ...
    //初始化数据
    getData() {
      getAssetsManageById(this.queryForm.manage_id).then((res) => {
        if (res.code == 0) {
          this.queryForm = res.data
          this.cabinetsChange(parseInt(res.data.cabinet_id));
    ...
    saveok() {
      this.$refs['form'].validate((v) => {
        if (v) {
          ...
          this.queryForm.uploadedFiles = uploadedFiles.join(',')
          this.queryForm.uploadedpictures = uploadedpictures.join(',')
