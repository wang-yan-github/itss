                      ...
                      <div class="box_content">
                        ...
                        <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                          <el-form-item label="机柜:" class="tsitem">
                            {{ queryForm.cabinet_name }}
                          </el-form-item>
                        </el-col>
                        <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                          <el-form-item label="起始机位:" class="tsitem">
                            {{ queryForm.start_seat_name }}
                          </el-form-item>
                        </el-col>
                        <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                          <el-form-item label="终止机位:" class="tsitem">
                            {{ queryForm.end_seat_name }}
                          </el-form-item>
                        </el-col>
                        <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                          <el-form-item label="IP地址1:" class="tsitem">
                            {{ queryForm.ip }}
                          </el-form-item>
                        </el-col>
                        <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                          <el-form-item label="IP地址2:" class="tsitem">
                            {{ queryForm.ip2 }}
                          </el-form-item>
                        </el-col>
                        <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                          <el-form-item label="MAC地址1:" class="tsitem">
                            {{ queryForm.mac }}
                          </el-form-item>
                        </el-col>
                        <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                          <el-form-item label="MAC地址2:" class="tsitem">
                            {{ queryForm.mac2 }}
                          </el-form-item>
                        </el-col>
                        <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                          <el-form-item label="MAC地址3:" class="tsitem">
                            {{ queryForm.mac3 }}
                          </el-form-item>
                        </el-col>
                        <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                        ...
                        <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                          <el-form-item label="服务器配置:" class="tsitem">
                            {{ queryForm.server_config }}
                          </el-form-item>
                        </el-col>
                        <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                        ...
                        <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                          <el-form-item
                            ...
                            class="tsitem"
                          >
                            {{ queryForm.server_code }}
                          </el-form-item>
                        </el-col>
                        <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                          <el-form-item label="OS许可证:" class="tsitem">
                            {{ queryForm.os_licence_name }}
                          </el-form-item>
                        </el-col>
                      </div>
                    </div>
