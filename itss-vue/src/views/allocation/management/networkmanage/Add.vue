            ...
            <el-row :gutter="20">
              ...
              <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                <el-card class="cardbox" shadow="hover">
                  ...
                  <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                    <el-form-item label="维保结束日期" prop="data2">
                      <el-date-picker
                 ...
                 <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                  ...
                  <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                    <el-form-item label="系统版本">
                      <el-input
                        v-model.trim="queryForm.os_edition"
                        placeholder="请输入系统版本"
                        autocomplete="off"
                      ></el-input>
                    </el-form-item>
...
import { toAssetsManageAdd,  getSeats,getAssetsByType } from '@/api/assetsManage'
