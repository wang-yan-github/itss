                ...
                <el-card class="cardbox" shadow="hover">
                  ...
                  <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                    <el-form-item label="财务编号">
                      <el-input
                        v-model.trim="form.finance_number"
                        placeholder="请输入"
                        autocomplete="off"
                      ></el-input>
                    </el-form-item>
                  ...
                  <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                    <el-form-item label="保密编号">
                      <el-input
                        v-model.trim="form.secrecy_number"
                        placeholder="请输入"
                        autocomplete="off"
                      ></el-input>
                    </el-form-item>
              ...
              <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                <el-card class="cardbox" shadow="hover">
                 ...
                 <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                  ...
                  <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                    <el-form-item label="硬件PIN">
                      <el-input
                        v-model.trim="form.pin"
                        placeholder="请输入硬件PIN"
                        autocomplete="off"
                      ></el-input>
                    </el-form-item>
                  </el-col>
