                ...
                <el-card class="cardbox" shadow="hover">
                  ...
                  <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                    <el-form-item label="操作系统">
                      <el-select v-model.trim="form.os_id" class="w">
                        <el-option
                  ...
                  <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                    <el-form-item label="系统安装时间" prop="data1">
                      <el-date-picker v-model="form.os_install_time" type="date" placeholder="选择日期"
                                      style="width: 100%;">
                      </el-date-picker>
                    </el-form-item>
                  </el-col>
                  <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                    <el-form-item label="硬盘序列号">
                      <el-input v-model.trim="form.harddisk_serial" placeholder='请输入' autocomplete="off">
                      </el-input>
                    </el-form-item>
                  </el-col>
                  <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                  ...
                  <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                    <el-form-item label="无线IP地址">
                      <el-input v-model.trim="form.wireless_ip" placeholder='请输入' autocomplete="off">
                      </el-input>
                    </el-form-item>
                  </el-col>
                  <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                    <el-form-item label="无线MAC地址">
                      <el-input v-model.trim="form.wireless_mac" placeholder='请输入' autocomplete="off">
                      </el-input>
                    </el-form-item>
                  </el-col>
                  <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                    <el-form-item label="CPU">
                      <el-input v-model.trim="form.cpu" placeholder='请输入' autocomplete="off">
                      </el-input>
                    </el-form-item>
                  </el-col>
                  <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                    <el-form-item label="内存">
                      <el-input v-model.trim="form.memory" placeholder='请输入' autocomplete="off">
                      </el-input>
                    </el-form-item>
                  </el-col>
                  <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                    <el-form-item label="硬盘">
                      <el-input v-model.trim="form.hard_disk" placeholder='请输入' autocomplete="off">
                      </el-input>
                    </el-form-item>
                  </el-col>
                </el-card>
