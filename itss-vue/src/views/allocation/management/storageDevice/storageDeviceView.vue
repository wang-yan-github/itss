                  ...
                  <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                    <div class="box_card">
                      ...
                      <div class="box_content">
                        ...
                        <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                          <el-form-item label="机柜:" class="tsitem">
                            {{ form.cabinet_name }}
                          </el-form-item>
                        </el-col>
                        <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                          <el-form-item label="起始机位:" class="tsitem">
                            {{ form.start_seat_name }}
                          </el-form-item>
                        </el-col>
                        <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                          <el-form-item label="终止机位:" class="tsitem">
                            {{ form.end_seat_name }}
                          </el-form-item>
                        </el-col>
                        <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                          <el-form-item label="分配容量:" class="tsitem">
                            {{ form.allocated_capacity }}
                          </el-form-item>
                        </el-col>
                        <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                          <el-form-item label="IP地址:" class="tsitem">
                            {{ form.ip }}
                          </el-form-item>
                        </el-col>
                        <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                          <el-form-item label="Raid信息:" class="tsitem">
                            {{ form.raid }}
                          </el-form-item>
                        </el-col>
                        <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                          <el-form-item label="MAC地址:" class="tsitem">
                            {{ form.mac }}
                          </el-form-item>
                        </el-col>
                        <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                          <el-form-item label="总容量:" class="tsitem">
                            {{ form.capacity }}
                          </el-form-item>
                        </el-col>
                      </div>
