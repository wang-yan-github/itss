<template>
  <div class="index-container pb80">
                ...
                <el-card class="cardbox" shadow="hover">
                  ...
                  <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                    <el-form-item label="品牌">
                      <el-select v-model.trim="form.brand_id" class="w">
                        <el-option
                  ...
                  <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                    <el-form-item label="型号">
                      <el-input v-model.trim="form.model" placeholder='请输入' autocomplete="off">
                      </el-input>
                    </el-form-item>
                  </el-col>
                  <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                    <el-form-item label="序列号(SN号)">
                      <el-input v-model.trim="form.sn" placeholder='请输入' autocomplete="off">
                      </el-input>
                    </el-form-item>
                  </el-col>
                  <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                  ...
                  <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                    <el-form-item label="起始机位">
                      <el-select v-model.trim="form.start_seat" class="w">
                        <el-option
                          v-for="item in seats"
                          :key="item.id"
                          :label="item.assets_name"
                  ...
                  <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                    <el-form-item label="终止机位">
                      <el-select v-model.trim="form.end_seat" class="w">
                        <el-option
                          v-for="item in seats"
                          :key="item.id"
                          :label="item.assets_name"
                  ...
                  <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                    <el-form-item label="分配容量">
                      <el-input v-model.trim="form.allocated_capacity" placeholder='请输入' autocomplete="off">
                      </el-input>
                    </el-form-item>
                  </el-col>
                  <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                    <el-form-item label="IP地址">
                      <el-input v-model.trim="form.ip" placeholder='请输入' autocomplete="off">
                      </el-input>
                    </el-form-item>
                  </el-col>
                  <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                    <el-form-item label="Raid信息">
                      <el-input v-model.trim="form.raid" placeholder='请输入' autocomplete="off">
                      </el-input>
                    </el-form-item>
                  </el-col>
                  <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                    <el-form-item label="MAC地址">
                      <el-input v-model.trim="form.mac" placeholder='请输入' autocomplete="off">
                      </el-input>
                    </el-form-item>
                  </el-col>
                  <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                    <el-form-item label="总容量">
                      <el-input v-model.trim="form.capacity" placeholder='请输入' autocomplete="off">
                      </el-input>
                    </el-form-item>
                  </el-col>
                </el-card>
    ...
    <div class="bottom">
      <el-button type="primary" size="medium" :loading="loadingbut" @click="saveok">保存</el-button>
  ...
  export default {
    ...
    methods: {
      async getData(val) {
        ...
        this.form = data;
        this.cabinetsChange(parseInt(data.cabinet_id));
