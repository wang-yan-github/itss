            ...
            <el-row :gutter="20">
              ...
              <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                <el-card class="cardbox" shadow="hover">
                  ...
                  <!--<el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">-->
                    <!--<el-form-item label="机柜">-->
                      <!--<el-input v-model.trim="form.cabinet_id" placeholder='请输入' autocomplete="off">-->
                      <!--</el-input>-->
                    <!--</el-form-item>-->
                  <!--</el-col>-->
                  <!--<el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">-->
                    <!--<el-form-item label="起始机位">-->
                      <!--<el-input v-model.trim="form.start_seat" placeholder='请输入' autocomplete="off">-->
                      <!--</el-input>-->
                    <!--</el-form-item>-->
                  <!--</el-col>-->
                  <!--<el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">-->
                    <!--<el-form-item label="终止机位">-->
                      <!--<el-input v-model.trim="form.end_seat" placeholder='请输入' autocomplete="off">-->
                      <!--</el-input>-->
                    <!--</el-form-item>-->
                  <!--</el-col>-->
                </el-card>
...
<script>
//配置管理新增保存接口
import {toAssetsManageAdd, getAssetsByType,getSeats} from '@/api/assetsManage'
//获取配置项子类
