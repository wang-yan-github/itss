                ...
                <el-card class="cardbox" shadow="hover">
                  ...
                  <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                    <el-form-item label="NBU">
                      <el-input v-model.trim="form.nbu" placeholder='请输入' autocomplete="off">
                      </el-input>
                    </el-form-item>
                  </el-col>
...
<script>
//配置管理新增保存接口
import {toAssetsManageEdit, getAssetsManageById, getAssetsByType,getSeats} from '@/api/assetsManage'
//获取配置项子类
...
export default {
  ...
  methods: {
    async getData(val) {
      ...
      this.form.start_seat = data.start_seat + "";
      this.form.end_seat = data.end_seat + "";
