                ...
                <el-card class="cardbox" shadow="hover">
                  ...
                  <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                    <el-form-item label="配置子类" prop="child_asset">
                      <el-select v-model.trim="form.child_asset" class="w">
                        <el-option
                ...
                <el-card class="cardbox" shadow="hover">
                  ...
                  <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                    <el-form-item label="配置项类型" prop="status">
                      ...
                      >
                        <el-option
                          :key="form.assets_type_id"
                          :label="form.assets_type_name"
...
<script>
//配置管理新增保存接口
import {toAssetsManageAdd, getAssetsByType, getAssetsManageList, getTypeIdByName } from '@/api/assetsManage'
//获取配置项子类
        ...
        if (res.code == 0) {
          ...
          for (var i= 0 ; i<this.assetsTypes.length;i++){
            if (this.assetsTypes[i].id == id ){
              this.form.assets_type_name = this.assetsTypes[i].name;
            }
          }
        }
      })
