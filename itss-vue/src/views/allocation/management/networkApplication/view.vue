                    ...
                    <div class="box_card">
                      ...
                      <div class="box_content">
                        <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                          <el-form-item label="url:" class="tsitem">
                            {{ form.url }}
                          </el-form-item>
                        </el-col>
                        <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                          <el-form-item label="数据库:" class="tsitem">
                            {{ form.real_data_base_Name }}
                          </el-form-item>
                        </el-col>
                        <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                          <el-form-item label="外网IP:" class="tsitem">
                            {{ form.extranet_ip }}
                          </el-form-item>
                        </el-col>
                        <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                          <el-form-item label="内网IP:" class="tsitem">
                            {{ form.intranet_ip }}
                          </el-form-item>
                        </el-col>
                        <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                          <el-form-item label="中间件名称及版本:" class="tsitem">
                            {{ form.mid_name_edition }}
                          </el-form-item>
                        </el-col>
                        <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                          <el-form-item label="软件厂商名称:" class="tsitem">
                            {{ form.software_manufacturer }}
                          </el-form-item>
                        </el-col>
                        <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                          <el-form-item label="实施厂商名称:" class="tsitem">
                            {{ form.implementation_manufacturer }}
                          </el-form-item>
                        </el-col>
                        <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                          <el-form-item label="应用系统技术负责人:" class="tsitem">
                            {{ form.js_liable }}
                          </el-form-item>
                        </el-col>
                        <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                          <el-form-item label="技术负责人联系电话:" class="tsitem">
                            {{ form.js_phone }}
                          </el-form-item>
                        </el-col>
                        <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                          <el-form-item label="系统业务负责人:" class="tsitem">
                            {{ form.yw_liable }}
                          </el-form-item>
                        </el-col>
                        <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                          <el-form-item label="业务负责人联系电话:" class="tsitem">
                            {{ form.yw_phone }}
                          </el-form-item>
                        </el-col>
                        <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                          <el-form-item label="启用类型:" class="tsitem">
                            {{ form.is_enable==null?'未知':form.is_enable==1?'启用':'停用' }}
                          </el-form-item>
                        </el-col>
                        <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                          <el-form-item label="备份方式:" class="tsitem">
                            {{ form.backup_id==null?'未知':form.backup_id==1?'定期备份':'实时备份' }}
                          </el-form-item>
                        </el-col>
                        <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                          <el-form-item label="系统上线时间:" class="tsitem">
                            {{ form.online_time }}
                          </el-form-item>
                        </el-col>
