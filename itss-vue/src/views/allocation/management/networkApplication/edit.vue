                ...
                <el-card class="cardbox" shadow="hover">
                  ...
                  <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                    <el-form-item label="url">
                      <el-input v-model.trim="form.url" placeholder='请输入' autocomplete="off"> </el-input>
                    </el-form-item>
                  </el-col>
                  <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                    <el-form-item label="数据库">
                      <el-select v-model.trim="form.databaseName" class="w">
                        <el-option
                  ...
                  <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                    <el-form-item label="外网IP">
                      <el-input v-model.trim="form.extranet_ip" placeholder='请输入' autocomplete="off"> </el-input>
                    </el-form-item>
                  </el-col>
                  <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                    <el-form-item label="内网IP">
                      <el-input v-model.trim="form.intranet_ip" placeholder='请输入' autocomplete="off"> </el-input>
                    </el-form-item>
                  </el-col>
                  <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                    <el-form-item label="中间件名称及版本">
                      <el-input v-model.trim="form.mid_name_edition" placeholder='请输入' autocomplete="off"> </el-input>
                    </el-form-item>
                  </el-col>
                  <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                    <el-form-item label="软件厂商名称">
                      <el-input v-model.trim="form.software_manufacturer" placeholder='请输入' autocomplete="off"> </el-input>
                    </el-form-item>
                  </el-col>
                  <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                    <el-form-item label="实施厂商名称">
                      <el-input v-model.trim="form.implementation_manufacturer" placeholder='请输入' autocomplete="off"> </el-input>
                    </el-form-item>
                  </el-col>
                  <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                    <el-form-item label="应用系统技术负责人">
                      <el-input v-model.trim="form.js_liable" placeholder='请输入' autocomplete="off"> </el-input>
                    </el-form-item>
                  </el-col>
                  <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                    <el-form-item label="技术负责人联系电话">
                      <el-input v-model.trim="form.js_phone" placeholder='请输入' autocomplete="off"> </el-input>
                    </el-form-item>
                  </el-col>
                  <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                    <el-form-item label="系统业务负责人">
                      <el-input v-model.trim="form.yw_liable" placeholder='请输入' autocomplete="off"> </el-input>
                    </el-form-item>
                  </el-col>
                  <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                    <el-form-item label="业务负责人联系电话">
                      <el-input v-model.trim="form.yw_phone" placeholder='请输入' autocomplete="off"> </el-input>
                    </el-form-item>
                  </el-col>
                  <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                  ...
                  <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                    <el-form-item label="备份方式">
                      <el-select v-model.trim="form.backup_id" class="w">
                        <el-option label="备份1" value="1"></el-option>
                        <el-option label="备份2" value="2"></el-option>
                      </el-select>
                    </el-form-item>
                  </el-col>
                  <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                    <el-form-item label="系统上线时间">
                      <el-date-picker v-model="form.online_time" type="date" placeholder="选择日期"
                                      style="width: 100%;">
                      </el-date-picker>
                    </el-form-item>
                  </el-col>
                  <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                    <!--<el-form-item label="扩展表单">-->
                      <!--&lt;!&ndash;                      <el-input v-model.trim="form.sn" placeholder='请输入' autocomplete="off"> </el-input>&ndash;&gt;-->
                    <!--</el-form-item>-->
                  </el-col>
                </el-card>
              </el-col>
...
<script>
//配置管理新增保存接口
import {toAssetsManageEdit, getAssetsManageById, getAssetsByType, getAssetsManageList, getTypeIdByName} from '@/api/assetsManage'
//获取配置项子类
...
export default {
  ...
  methods: {
    async getData(val) {
      ...
      this.form = data;
      this.form.is_enable = data.is_enable+"";
      this.form.backup_id = data.backup_id+"";
      this.form.is_secrecy= data.is_secrecy + "";

      for (var i = 0 ; i< data.contractContactList.length ; i++){
        if (data.contractContactList[i].is_enable == 0){
          data.contractContactList[i].is_enable_name = '禁用';
        } else {
          data.contractContactList[i].is_enable_name = '启用';
        }
      }

      this.contractContactList = data.contractContactList;
      this.supplierContractList = data.supplierContractList;
      this.assetsTypeList = data.assetsTypeList;

      if (data.fileManageList) {
        data.fileManageList.forEach((x) => {
    ...
    /*--获取数据库实例--*/
    getDatabaseList() {
      getTypeIdByName('数据库模式管理').then((res) =>{
        if(res.code != 0) {
          return;
        }
        var params = {};
        ...
        params.assets_type_id = res.data.id;
        getAssetsManageList(JSON.stringify(params)).then((res) => {
          if (res.code == 0) {
