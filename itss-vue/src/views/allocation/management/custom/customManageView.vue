...
<!--                        </el-col>-->
<!--                        <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">-->
<!--                          <el-form-item label="维保结束日期:" class="tsitem">-->
<!--                            {{ form.end_time }}-->
<!--                          </el-form-item>-->
<!--                        </el-col>-->
<!--                      </div>-->
...
<!--                            <el-input v-model="dyFieldItems[item.id]" readOnly></el-input>-->
<!--                          </el-form-item>-->

<!--                          &lt;!&ndash;长文本&ndash;&gt;-->
<!--                          <el-form-item v-if="item.type == 1">-->
<!--                            <label slot="label">{{item.name}}</label>-->
<!--                            <el-input type="textarea" v-model="dyFieldItems[item.id]" readOnly></el-input>-->
<!--                          </el-form-item>-->

<!--                          &lt;!&ndash;整数&ndash;&gt;-->
<!--                          <el-form-item v-if="item.type == 2">-->
<!--                            <label slot="label">{{item.name}}</label>-->
<!--                            <el-input v-model="dyFieldItems[item.id]" type="number" placeholder="请输入内容"  onKeypress="return (/[\d]/.test(String.fromCharCode(event.keyCode)))" readOnly></el-input>-->
<!--                          </el-form-item>-->

<!--                          &lt;!&ndash;小数&ndash;&gt;-->
<!--                          <el-form-item v-if="item.type == 3">-->
<!--                            <label slot="label">{{item.name}}</label>-->
<!--                            <el-input v-model="dyFieldItems[item.id]"  type="number" readOnly></el-input>-->
<!--                          </el-form-item>-->

<!--                          &lt;!&ndash;日期&ndash;&gt;-->
<!--                          <el-form-item v-if="item.type == 4">-->
<!--                            <label slot="label">{{item.name}}</label>-->
<!--                            <el-date-picker v-model="dyFieldItems[item.id]"  type="datetime" placeholder="选择日期时间" readOnly>-->
<!--                            </el-date-picker>-->
<!--                          </el-form-item>-->
...
<!--                            <label slot="label">{{item.name}}</label>-->
<!--                            <el-radio-group v-model="dyFieldItems[item.id]" readOnly>-->
<!--                              <el-radio v-for="(fieldItem,index) in item.fieldVal" :key="fieldItem.fId" :label="fieldItem.fId" disabled>{{fieldItem.fVal}}</el-radio>-->
<!--                            </el-radio-group>-->
<!--                          </el-form-item>-->
...
<!--                            <el-checkbox-group v-model="dyFieldItemsCheck[index-1]" readOnly>-->
<!--                              <el-checkbox v-for="data in item.fieldVal" :label="data.fId" :key="data.fVal" disabled>-->
<!--                                {{data.fVal}}-->
<!--                              </el-checkbox>-->
<!--                            </el-checkbox-group>-->
<!--                          </el-form-item>-->
...
<!--                  </el-col>-->
              ...
              <el-tab-pane label="联系人" name="second">
                <el-table :data="contractContactList" stripe border>
                  ...
                  <el-table-column show-overflow-tooltip prop="phone" align="center" label="Phone" sortable>
                  </el-table-column>
              ...
              <el-tab-pane label="供应商合同" name="third">
                <el-table :data="supplierContractList" stripe border>
                  ...
                  <el-table-column show-overflow-tooltip prop="renew_time" align="center" label="开始时间" sortable>
                  </el-table-column>
                  <el-table-column show-overflow-tooltip prop="renew_time" align="center" label="结束时间" sortable>
                  </el-table-column>
              ...
              <el-tab-pane label="关联的配置项" name="fourth">
                <el-table :data="assetsTypeList" stripe border>
                  ...
                  <el-table-column show-overflow-tooltip prop="it_status" label="IT状态" sortable
                                   align="center"></el-table-column>
                </el-table>
              </el-tab-pane>
          ...
          <el-card shadow="never" class="hasiscoll">
            <div class="box_card">
              ...
              <div class="box_content">
                ...
                <el-form-item label="ID:" class="mb0">
                  {{ form.id }}
                </el-form-item>
