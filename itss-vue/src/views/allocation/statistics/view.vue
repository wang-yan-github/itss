<template>
    ...
    <el-form :inline="true" :model="queryForm" @submit.native.prevent>
      ...
      <vab-query-form-left-panel :span="18">
          ...
          <el-form-item>
          	<el-button plain>日报</el-button>
          </el-form-item>
          <el-form-item>
          	<el-button plain>周报</el-button>
          </el-form-item>
          <el-form-item>
          	<el-button type="primary" plain>月报</el-button>
          </el-form-item>
          <el-form-item>
          	<el-button plain>季报</el-button>
          </el-form-item>
          <el-form-item>
          	<el-button plain>年报</el-button>
          </el-form-item>
          <el-form-item>
          	<el-button plain>固定时间</el-button>
          </el-form-item>
      		<el-form-item>
      			<el-date-picker
      			      v-model="value1"
