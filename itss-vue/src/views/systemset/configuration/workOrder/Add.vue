<template>
  <div class="main-container pb80">
                ...
                <el-card class="cardbox" shadow="hover">
                  ...
                  <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                    <el-form-item label="上级" prop="parent_id">
                      <el-input autocomplete="off" placeholder="请选择" style="width: 80%;" v-model="form.parent_id"
                                @click.native="openwinSuperior"></el-input>
                  ...
                  <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                    ...
                    <!--<el-form-item prop="sla_id" label="SLA">-->
                  ...
                  <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                    <el-form-item label="是否抄送负责人" prop="is_send_charge">
          ...
          <el-tab-pane label="负责人" name="fourth">
            <el-card shadow="never" style="border-top: 0">
              <div class="box_card">
                <!-- <div class="box_header">工程师开单通知用户</div> -->
                <div class="box_content">
                  <el-table ref="listTable" border stripe :data="fzrList"
                  ...
                  <div class="btn-box" style="margin-top: 10px;">
                    ...
                    <el-button type="primary" icon="el-icon-plus" @click="handleAddFzr">
                      添加
                    </el-button>
                  </div>
                </div>
          ...
          <el-tab-pane label="协查人" name="third">
            <el-card shadow="never" style="border-top: 0">
              <div class="box_card">
                <!-- <div class="box_header">工程师开单通知用户</div> -->
                <div class="box_content">
                  <el-table ref="listTable" border stripe :data="xcrList"
                            :element-loading-text="elementLoadingText" highlight-current-row
                  ...
                  <div class="btn-box" style="margin-top: 10px;">
                    <el-button type="danger" icon="el-icon-delete" @click="handleDeleteContract2">
                      移除选择对象
                    </el-button>
                    <el-button type="primary" icon="el-icon-plus" @click="handleAddXcr">
                      添加
                    </el-button>
                  </div>
                </div>
    ...
    <superior ref="superior" @categoryData="getParentId" @fetch-data=""></superior>
    <customerContractDia
...
<script>
  ...
  import {
    add, eventCategoryinfo
  } from '@/api/event_category'
  ...
  export default {
    ...
    methods: {
      ...
      getParentId(data) { //触发子组件城市选择-选择城市的事件
        var that = this;
