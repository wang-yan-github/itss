<template>
  <div class="index-container pb80">
      ...
      <el-row :gutter="20">
        <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
          <el-card class="cardbox" shadow="hover">
            ...
            <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
              <el-form-item label="公共模板" prop="is_public">
                <el-select
            ...
            <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
              ...
              <!--</template>-->
              <!--</el-form-item>-->
              <el-form-item label="所属服务群组" prop="event_service_id">
                <el-select
                  v-model="form.event_service_id"
                  placeholder="请选择"
                  style="width: 100%"
                >
                  <el-option
            ...
            <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
              <el-form-item label="描述" prop="">
                <el-input
                  v-model.trim="form.template_desc"
                  autocomplete="off"
                  type="textarea"
                  :rows="5"
                ></el-input>
            ...
            <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
              <el-form-item label="用户">
                ...
                >
                  ...
                  <el-option
                    v-for="item in auto_engineer_data"
                    :key="item.id"
                    :label="item.name"
                    :value="item.id"
                  ></el-option>
        ...
        <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
          <el-card class="cardbox" shadow="hover">
            ...
            <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
              ...
              <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                <el-form-item label="请求类型" prop="request_type">
                  ...
                  >
                    <el-option
                      v-for="item in eventRequestData"
                      :key="item.id"
            ...
            <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
              <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                <el-form-item label="紧急度" prop="urgency_degree">
                  <el-select
                    v-model="form.urgency_degree"
                    placeholder="请选择"
                    style="width: 100%"
                  >
                    <el-option
                      v-for="item in slaEventUrgentData"
                      :key="item.id"
              ...
              <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                <el-form-item label="影响度" prop="effect_degree">
                  <el-select
                    v-model="form.effect_degree"
                    placeholder="请选择"
                    style="width: 100%"
                  >
                    <el-option
                      v-for="item in upSlaEventImpactData"
                      :key="item.id"
          ...
          <el-card class="cardbox" shadow="hover">
            ...
            <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
              <el-form-item label="解决方式">
                <el-select
                  v-model="form.solve_type"
                  placeholder="请选择"
                  style="width: 100%"
                >
                  <el-option
                    v-for="item in upEventSolutionTypeData"
                    :key="item.id"
            ...
            <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
              <el-form-item label="方案分类">
                <el-input
                  @click.native="openwinTree"
                  v-model="form.programme_type_name"
                  autocomplete="off"
                  placeholder="请选择方案分类"
                  style="width: 80%"
                ></el-input>
        ...
        <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
          <el-alert
            title="配置参数:(标题、描述和解决方案) "
            :closable="false"
            type="success"
          >
            日期（例如：2019-01-08）: (DATE) 时间（例如：2019-01-08 15:36:22）:
            (DATETIME)
          </el-alert>
        </el-col>
      </el-row>
    ...
    <children
      ref="children"
      @categoryData="getBillType"
      @fetch-data="getBillType"
    ></children>
    <nameTable ref="nameTable" @userData="getHandlerUser"></nameTable>
    <userDia ref="userDia" @userData="getUser"></userDia>
    <codeTree
      ref="codeTree"
      @programmeTypeData="getSchemeClassIfication"
    ></codeTree>
  </div>
</template>
<script>
  import vabQuill from '@/plugins/vabQuill'
  import {upList} from '@/api/selfService'
  ...
  import nameTable from '@/components/UserSelectModel'
  import userDia from '@/components/UserSelectModel'
  import codeTree from '@/components/fanganclass'
