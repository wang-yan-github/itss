      ...
      <template>
        <el-tabs v-model="activeName">
                ...
                <el-card class="cardbox" shadow="hover">
                  ...
                  <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                    <el-form-item label="开始日期" prop="begin_time">
                      <el-date-picker v-model="form.begin_time" type="date" placeholder="选择日期"
                                      style="width: 100%;">
                      </el-date-picker>
                    </el-form-item>
                  </el-col>
          ...
          <el-tab-pane label="工单模板" name="second">
            <el-table ref="listTable" border stripe :data="contractContactList"
  ...
  export default {
    ...
    methods: {
      ...
      saveok() {
        ...
        // console.log(that.form.interval_day)
        // console.log(that.form.interval_day.join(","))
        // return false;
        that.$refs['form'].validate(async (valid) => {
          if (valid) {
            ...
            that.form.eventTemplateList = that.contractContactList;
            console.log(that.form)
      ...
      listAssetsContract(rows) {
        ...
        console.log(this.contractContactList);
      },
    },
  }
</script>
