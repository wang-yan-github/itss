<template>
  <div class="index-container">
    <vab-query-form>
      ...
      <vab-query-form-right-panel :span="16">
        <el-form :inline="true" :model="queryForm" @submit.native.prevent>
          ...
          <el-form-item>
            <el-input v-model.trim="queryForm.group_name" placeholder="名称" clearable @keyup.enter.native="queryData"/>
          </el-form-item>
          <el-form-item>
    ...
    <el-table v-loading="listLoading" ref="listTable" stripe :data="list" :element-loading-text="elementLoadingText"
      ...
      <el-table-column show-overflow-tooltip prop="group_name" sortable label="名称" header-align="center" align="center">
        <template slot-scope="scope">
          <el-link @click="handleProcess(scope.row)">{{scope.row.group_name}}</el-link>
        </template>
      </el-table-column>
      <el-table-column show-overflow-tooltip prop="en_name" width="200px;" align="center" sortable
                       label="英文名称"></el-table-column>
      <el-table-column show-overflow-tooltip prop="is_enable" width="200px;" label="状态" sortable align="center">
        <template slot-scope="scope">
          <el-tag type="success" v-if="scope.row.is_enable == '1'">使用</el-tag>
          <el-tag type="danger" v-else>禁用</el-tag>
        </template>
      </el-table-column>
      <el-table-column show-overflow-tooltip prop="sort" width="200px;" align="center" sortable
...
<script>
  import {getList, doDelete} from '@/api/assetsClGroup'
