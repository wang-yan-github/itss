<template>
  <div class="index-container">
    ...
    <el-table v-loading="listLoading" ref="listTable" stripe :data="list" :element-loading-text="elementLoadingText"
      ...
      <el-table-column show-overflow-tooltip prop="os_name" sortable label="名称" header-align="center" align="center">
        <template #default="{ row }">
          <el-link @click="handleProcess(row)">{{row.os_name}}</el-link>
        </template>
      </el-table-column>
      <el-table-column show-overflow-tooltip prop="sort" width="200px;" label="排序" sortable
...
<script>
  import {getList, doDelete} from '@/api/assetsOs'
