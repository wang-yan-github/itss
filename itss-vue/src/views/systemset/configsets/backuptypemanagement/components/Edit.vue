<template>
  ...
  >
    <el-form ref="form" :model="form" :rules="rules" label-width="80px">
      <el-form-item label="名称" prop="backup_name">
        <el-input v-model.trim="form.backup_name" autocomplete="off"></el-input>
      </el-form-item>
      <el-form-item
        label="状态"
        prop="is_enable"
...
<script>
  import {toSave} from '@/api/assetsBackup'
  ...
  export default {
    ...
    data() {
      return {
        ...
        rules: {
          backup_name: [{required: true, trigger: 'blur', message: '请输入名称'}],
          is_enable: [
