<template>
  <div class="index-container">
    ...
    <el-table v-loading="listLoading" ref="listTable" stripe :data="list" :element-loading-text="elementLoadingText"
      ...
      <el-table-column show-overflow-tooltip prop="os_licence_name" sortable label="名称" header-align="center"
                       align="center">
        <template #default="{ row }">
          <el-link @click="handleProcess(row)">{{row.os_licence_name}}</el-link>
        </template>
      </el-table-column>
      <el-table-column show-overflow-tooltip prop="deptName" width="120px;" label="部门" sortable
                       align="center"></el-table-column>
      <el-table-column show-overflow-tooltip prop="start_time" width="160px;" align="center" sortable
                       label="开始时间"></el-table-column>
      <el-table-column show-overflow-tooltip prop="end_time" width="160px;" align="center" sortable
                       label="结束时间"></el-table-column>
      <el-table-column show-overflow-tooltip prop="key_license" width="200px;" align="center" sortable
                       label="KEY"></el-table-column>
      <el-table-column show-overflow-tooltip prop="is_limit" width="130px;" align="center" sortable label="是否无限期">
        <template slot-scope="scope">
          <el-tag type="success" v-if="scope.row.is_limit == 0">有期限</el-tag>
          <el-tag type="warning" v-else>无期限</el-tag>
        </template>
      </el-table-column>
    </el-table>
...
<script>
  import {getList, doDelete} from '@/api/assetsOsLicence'
