<template>
  <div class="index-container">
    <vab-query-form>
      ...
      <vab-query-form-right-panel :span="16">
        <el-form :inline="true" :model="queryForm" @submit.native.prevent>
          ...
          <el-form-item>
            <el-input v-model.trim="queryForm.request_name" placeholder="名称" clearable @keyup.enter.native="queryData"/>
          </el-form-item>
          <el-form-item>
    ...
    <el-table v-loading="listLoading" ref="listTable" stripe :data="list" :element-loading-text="elementLoadingText"
      ...
      <el-table-column show-overflow-tooltip prop="request_name" sortable label="名称" header-align="center"
                       align="center">
        <template #default="{ row }">
          <el-link @click="handleProcess(row)">{{row.request_name}}</el-link>
        </template>
      </el-table-column>
      <el-table-column show-overflow-tooltip prop="description" align="center" label="描述" sortable></el-table-column>
...
<script>
  import {getList, doDelete} from '@/api/assetsRequestConfig'
