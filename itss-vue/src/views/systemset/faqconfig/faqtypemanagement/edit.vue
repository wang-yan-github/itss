        ...
        <el-row :gutter="20">
          ...
          <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
            <el-form-item label="鉴定人:" prop="appraisal_name">
              <el-input
                v-model.trim="form.appraisal_name"
                autocomplete="off"
          ...
          <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
            <el-form-item label=" 审批人:" prop="list">
              ...
              <el-table
                ...
                @selection-change="setSelectContactRows3"
              >
...
<script>
  import {getList, doDelete, saveOrUpd, getById} from '@/api/questionSet'
    ...
    data() {
      return {
        ...
        rules: {
          ...
          // parent_id: [{ required: true, trigger: 'blur', message: '父类级别不能为空' }],
          // sort: [{ required: true, trigger: 'blur', message: '排序不能为空' }],
          appraisal_name: [{required: true, trigger: 'blur', message: '鉴定人不能为空'}],
