<template>
  <el-dialog :title="title" :visible.sync="dialogFormVisible" width="1200px" @close="close" top="80px">
      ...
      <el-row :gutter="20">
        ...
        <el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="8">
          <el-form-item label="发布人" prop="bumen">
            <el-input placeholder="请输入内容" v-model="input2" @click.native="openwin">
        ...
        <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
          <el-form-item label="">
            ...
            <el-table v-loading="listLoading" :data="tableData" border highlight-current-row
                      :element-loading-text="elementLoadingText" @selection-change="setSelectRows" height="300">
              ...
              <el-table-column show-overflow-tooltip prop="state" label="状态" sortable align="center"></el-table-column>
              <el-table-column show-overflow-tooltip prop="gongchengshi" label="电话" align="center"></el-table-column>
              <el-table-column show-overflow-tooltip prop="paixu" label="类型" align="center" sortable></el-table-column>
              <el-table-column show-overflow-tooltip label="排序" align="center">
            ...
            <div style="margin-top: 10px">
              ...
              <el-button type="primary" icon="el-icon-plus" @click="handleAdd">添加审批人</el-button>
            </div>
          </el-form-item>
        </el-col>
      </el-row>
    ...
    <children ref="children" @fetch-data=" { bumen }"></children>
    <dialogone ref="dialogone" @fetch-data=" { input2 }"></dialogone>
  </el-dialog>
</template>
