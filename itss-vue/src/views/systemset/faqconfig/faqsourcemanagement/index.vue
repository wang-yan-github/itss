<template>
  <div class="index-container">
    ...
    <el-table v-loading="listLoading" ref="listTable" stripe :data="list" :element-loading-text="elementLoadingText"
      ...
      <el-table-column show-overflow-tooltip prop="name" sortable label="名称" header-align="center"
                       align="center"></el-table-column>
      <el-table-column show-overflow-tooltip prop="use_name" width="200px;" label="状态" sortable align="center">
        <template slot-scope="scope">
          <el-tag type="success" v-if="scope.row.use_name === '启用'">启用</el-tag>
          <el-tag type="danger" v-else>禁用</el-tag>
        </template>
      </el-table-column>
      <el-table-column show-overflow-tooltip prop="description" align="center" header-align="center" label="描述"
...
<script>
  import {getList, doDelete} from '@/api/questionSet'
