          ...
          <el-card shadow="never" class="hasiscoll">
            <div class="box_card">
              ...
              <div class="box_content">
                ...
                <el-form-item label="当前操作人:" class="mb0">
                  {{ form.now_operator_user_name }}
                </el-form-item>
                ...
                <el-form-item label="期望解决时间:" class="mb0">
                  {{ form.hope_solve_time }}
                </el-form-item>
              </div>
            </div>
            <div class="box_card">
              ...
              <div class="box_content">
                ...
                <el-form-item label="解决分钟数:" class="mb0">
                  {{
                    form.resolution_minutes == null ||
...
<script>
import { getQuestionById, onDbHandleUpd } from '@/api/question'
...
export default {
  ...
  data() {
    return {
      ...
      firstList: [],
      sourceList: [],
      loadingbut1: false, //默认提交按钮可点击
      loadingbut2: false, //默认提交按钮可点击
      disabledData: false,
  ...
  methods: {
    ...
    async getData() {
      ...
      data.questionReviewers.forEach((item, i) => {
        this.stepData.push({ title: '审核', description: item.update_time })
      })
    ...
    handleAdd(val) {
      ...
      //   if (valid) {
      //     const {msg} = await onDbHandleUpd(this.form);
