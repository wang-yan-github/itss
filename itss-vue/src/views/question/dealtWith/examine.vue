          ...
          <el-card shadow="never">
            <el-tabs v-model="activeName" type="card">
              <el-tab-pane label="属性" name="first">
                ...
                <div class="box_card" v-for="(item, index) in this.form.questionReviewers" :key="index">
                  ...
                  <div class="box_content">
                    <el-row :gutter="20">
                      ...
                      <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                        <el-form-item label="审核意见:" v-if="form.audit_user == item.review_user">
                          <vab-quill
                            v-model="form.audit_content"
                            :min-height="200"
                            :options="options"
                          ></vab-quill>
                          <p class="ts">
                ...
                <div class="box_card">
                  <div class="box_header">问题审核通知</div>
                  <div class="box_content">
                    <el-row :gutter="20">
                ...
                <div class="box_card">
                  <div class="box_content">
                    <el-timeline>
                      ...
                      <el-timeline-item
                        v-for="(log, index) in form.questionLogs"
                        :key="index"
...
<!--                <el-form-item label="关单时限:" class="mb0">{{ form.time_limit }}</el-form-item>-->
            ...
            <div class="box_card">
              ...
              <div class="box_content step_content">
                <el-steps :active="timeStatus" align-center>
                  <el-step :title="item.title" v-for="item in stepData" :key="item.id" :description="item.description"></el-step>
                </el-steps>
              </div>
            </div>
          </el-card>
      ...
      <div class="bottom">
        <el-button type="primary" size="medium" :loading="loadingbut" @click="handleAdd(1)">
          通过
        </el-button>
        <el-button type="warning" size="medium" :loading="loadingbut" @click="handleAdd(2)">
          拒绝
        </el-button>
        <!-- <el-dropdown
          trigger="click"
...
<script>
  import {getQuestionById, onDbAuditUpd} from '@/api/question'
  ...
  export default {
    name: 'dealExamine',
    components: {vabQuill, eventDialog, changeDialog},
    data() {
      return {
        events_type:'1',
        firstList: [],
    ...
    methods: {
      ...
      async getData() {
        ...
        data.questionReviewers.forEach((item, i) => {
          this.stepData.push({title: item.review_user_name+"审核", description: this.parseDateTimeFull(item.update_time)});
        });
      ...
      handleEventsAdd() {
        this.$refs['eventDialog'].showWin(this.events_type)
      },
      handleChangeAdd() {
      ...
      handleAdd(val) {
        ...
        this.$refs['form'].validate(async (valid) => {
          ...
          if (valid) {
            const {msg} = await onDbAuditUpd(this.form);
