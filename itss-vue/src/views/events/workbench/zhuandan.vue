<template>
  <div class="main-container pb80">
    <el-form ref="form" label-width="100px">
            ...
            <el-tabs v-model="activeName" type="card">
              <el-tab-pane label="属性" name="first">
                <div class="box_card">
                  ...
                  <div class="box_content">
                    ...
                    <el-form-item label="描述:" class=""><div class="ql-editor content-detail" v-html="form.description"></div></el-form-item>
                  ...
                  <div class="box_content">
                    <el-row :gutter="20">
                      <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                        <el-form-item label="开单人:">{{ form.create_user_name }}</el-form-item>
                      </el-col>
                      <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                        <el-form-item label="开单时间:">{{ form.create_time }}</el-form-item>
                      </el-col>
                      <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                        <el-form-item label="响应时间:">{{ form.responseTime }}</el-form-item>
                      </el-col>
                      <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                        <el-form-item label="上次更新时间:">{{ form.update_time }}</el-form-item>
                      </el-col>
                      <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                        <el-form-item label="费用:">{{ form.expenses }}</el-form-item>
                      </el-col>
                      <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                        <el-form-item label="服务群组:">
                          <el-select v-model="form.service_groups_id" class="w" @change="serviceGroupsChange" >
                      ...
                      <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                        <el-form-item label="处理人:">
                          <el-input v-model.trim="form.handler_name" placeholder="" clearable @click.native="handlegd">
                      ...
                      <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                        <el-form-item label="备注:">
                          <vab-quill v-model="form.transferRemark" :min-height="200" :options="options"></vab-quill>
                          <p class="ts">
              ...
              <el-tab-pane :label="towUser" name="fourth">
                ...
                >
                  <el-table-column show-overflow-tooltip type="selection" align="center"></el-table-column>
                  <el-table-column show-overflow-tooltip type="index" label="序号" width="60" sortable align="center"></el-table-column>
                  <el-table-column show-overflow-tooltip prop="assets_number" label="资产编号" sortable align="center"></el-table-column>
                  <el-table-column show-overflow-tooltip prop="assetsTypeName" label="配置项类型"></el-table-column>
                  <el-table-column show-overflow-tooltip prop="childAssetName" label="配置子类" sortable align="center"></el-table-column>
                  <el-table-column show-overflow-tooltip prop="assets_name" label="资产名称" sortable align="center"></el-table-column>
                  <el-table-column show-overflow-tooltip prop="deptName" label="部门" sortable align="center"></el-table-column>
                  <el-table-column show-overflow-tooltip prop="receiverName" label="领用人" sortable align="center"></el-table-column>
                  <el-table-column show-overflow-tooltip prop="purchaseCompanyName" label="购置公司" sortable align="center"></el-table-column>
              ...
              <el-tab-pane :label="fourUser" name="six">
                <el-table
                  ...
                  <el-table-column show-overflow-tooltip prop="title" sortable label="标题" align="center"></el-table-column>
                  <el-table-column show-overflow-tooltip prop="create_user_name" label="创建人" align="center" sortable></el-table-column>
                  <el-table-column show-overflow-tooltip prop="create_time" label="创建时间" align="center" sortable></el-table-column>
                  <el-table-column show-overflow-tooltip prop="category_name" label="问题类别" align="center" sortable></el-table-column>
                  <el-table-column show-overflow-tooltip prop="hope_solve_time" label="期望解决时间" align="center" sortable></el-table-column>
                  <el-table-column show-overflow-tooltip prop="priority_name" label="优先级" align="center" sortable></el-table-column>
                  <el-table-column show-overflow-tooltip prop="status_name" align="center" label="状态" sortable></el-table-column>
                  <el-table-column show-overflow-tooltip prop="now_operator_user_name" align="center" label="当前操作人" sortable></el-table-column>
                  <el-table-column show-overflow-tooltip prop="solve_time" align="center" label="解决时间" sortable></el-table-column>
                </el-table>
                <div style="margin-top: 10px">
              ...
              <el-tab-pane :label="sixUser" name="eight">
                ...
                >
                  ...
                  <el-table-column show-overflow-tooltip prop="statusName" label="状态" sortable align="center"></el-table-column>
      ...
      <div class="bottom">
        <el-button type="primary" size="medium" @click="save">转单</el-button>

        <dialogtwo ref="dialogtwo" @userData="userSet" @fetch-data=" { input2 }"></dialogtwo>
      </div>
    </el-form>
    ...
    <changeDialog ref="changeDialog" @listData="listChanges" @fetch-data=""></changeDialog>
  </div>
</template>

<script>
  import vabQuill from '@/plugins/vabQuill'
  import {getById, getEventImpactMap, getRequestTypeMap, getSourceMap, userHistory} from "@/api/eventAllManage";
  import {getAllManageInfo} from '@/api/eventAllManage'
  import {transferOrder} from '@/api/event'
  ...
  export default {
    ...
    methods: {
      ...
      serviceGroupsChange(){
        ...
        if(this.form.service_groups_id != null && this.form.service_groups_id != undefined && this.form.service_groups_id != ''){
          info(this.form.service_groups_id).then((res) => {
            if (res.code == 0) {
              if (res.data.eventServiceManage.is_automatic_transfer == 1) {
      ...
      async getData() {
        ...
        const {data} = await getById({id: query.id.id})
        data.data.handle_user = "";
        data.data.handle_user_name = "";
        console.log("取到路由带过来的参数得到data:",data);
        this.form = data.data

        this.form.service_groups_id = data.data.service_groups_id ;
        this.serviceGroupsChange();
        //协查人
        this.oneUser = "协查人(" + this.form.eventAssistUsers.length + ")";
        this.towUser = "关联的配置项(" + this.form.assetsManages.length + ")";
        this.threeUser = "关联的工单(" + this.form.eventList.length + ")";
      ...
      handlegd() {
        ...
        data.type = 2;
        this.$refs['dialogtwo'].showWin(data)
      },
      ...
      async fetchData1() {
        const {data} = await getAllManageInfo({"isAll":"3"});
        this.list = data;
      },
      async save() {
        // 定义任务flag
        ...
        if (taskFlag) {
          info(this.form.service_groups_id).then(res => {
            ...
            transferOrder(this.form).then(res => {
            ...
            // const {msg} = await transferOrder(this.form)
          })
        }else{
          if (null == this.form.id){
            this.form.id = this.$route.query.id
