<template>
  <div class="main-container pb80">
    <el-form ref="form" label-width="90px">
            ...
            <el-tabs v-model="activeName" type="card">
              <el-tab-pane label="属性" name="first">
                <div class="box_card">
                  ...
                  <div class="box_content">
                    <el-form-item label="标题:" class="tsitem">{{ form.title }}</el-form-item>
                    ...
                    <el-form-item label="附件:" class="tsitem">
                      <div class="bghui" v-for="item in this.fileManageHandleList" :key="item.id">
                        <div class="r">
                          <p class="p1" style="margin: 0; color: #333" @click="downloadPic(item.id, item.file_name)">{{item.file_name}}</p>
                        </div>
                      </div>
                    </el-form-item>
                  </div>
                    ...
                    <el-row :gutter="20">
                      <el-col :xs="24" :sm="24" :md="6" :lg="8" :xl="6">
                        <el-form-item label="来源:">
                          <el-select v-model="form.source_id" class="w">
                            <el-option v-for="(item,index) in sourceList" :key="index" :label="item.resource_name"
                      ...
                      <el-col :xs="24" :sm="24" :md="6" :lg="8" :xl="6">
                        <el-form-item label="工单类别:">
                          <el-input v-model.trim="form.event_category_name" placeholder="" @click.native="handlegd">
                            <!--<el-button slot="append" icon="el-icon-search" @click="handlegd"></el-button>-->
                          </el-input>
                        </el-form-item>
                      </el-col>
                      <el-col :xs="24" :sm="24" :md="6" :lg="8" :xl="6">
                        <el-form-item label="影响度:">
                          <el-select v-model="form.effect_degree" class="w" @change="getFirst">
                            <el-option v-for="(item,index) in eventImpactList" :key="index" :label="item.impact_name" :value="item.id"></el-option>
                          </el-select>
                        </el-form-item>
                      </el-col>
                      <el-col :xs="24" :sm="24" :md="6" :lg="8" :xl="6">
                        <el-form-item label="紧急度:">
                          <el-select v-model="form.urgency_degree_id" class="w" @change="getFirst">
                            <el-option v-for="(item,index) in urgencyDegreeList" :key="item.id" :label="item.urgent_name" :value="item.id"></el-option>
                          </el-select>
                        </el-form-item>
                      </el-col>
                      <el-col :xs="24" :sm="24" :md="6" :lg="8" :xl="6">
                      ...
                      <el-col :xs="24" :sm="24" :md="6" :lg="8" :xl="6">
                        <el-form-item label="优先级:">{{ form.priority_name }}</el-form-item>
                      </el-col>
                      <el-col :xs="24" :sm="24" :md="6" :lg="8" :xl="6">
                        <el-form-item label="响应SLA/ 解决SLA:" class="tsitem">{{ResponseSLA}}</el-form-item>
                      </el-col>
                    </el-row>
                  </div>
                </div>
                ...
                <div class="box_card">
                  <div class="box_header">指派信息</div>
                  <div class="box_content">
                    <el-row :gutter="20">
                      <el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="8">
                        <el-form-item label="服务群组:">
                          <el-select v-model="form.service_groups_id" @change="serviceGroupsChange" placeholder="服务群组" class="w">
                      ...
                      <el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="8">
                        <el-form-item label="处理人:">
                          <el-input v-model.trim="form.handler_name" placeholder="处理人" clearable @click.native="handleRole1"></el-input>
                        </el-form-item>
                      </el-col>

                      <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                        <el-form-item label="备注:">
                          <vab-quill v-model="form.appointRemark" :min-height="200" :options="options"></vab-quill>
                          <p class="ts">
                      ...
                      <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                        <el-form-item label="附件:" style="width: 400px;">
                          <el-upload
                            ...
                            :file-list="clfileManageHandleList"
              ...
              <el-tab-pane :label="sevenUser" name="second">
                <div class="box_card">
                  <div class="box_content">
                    <el-timeline>
                      <el-timeline-item v-for="(log, index) in form.sysLogs" :key="index" :timestamp="log.operate_time" placement="top" size="large" color="#0bbd87">
                        <el-card>
                          <h4>{{ log.title }}</h4>
                          <p>{{ log.user_name }}</p>
              ...
              <el-tab-pane :label="oneUser" name="third">
                <el-table :data="form.eventAssistUsers" stripe border @selection-change="setSelectPeopleRows" height="calc(100vh - 400px)">
                  <el-table-column show-overflow-tooltip type="selection" align="center"></el-table-column>
                  <el-table-column show-overflow-tooltip type="index" label="序号" width="80px" align="center"></el-table-column>
                  <el-table-column show-overflow-tooltip prop="user_name" label="用户名"></el-table-column>
                  <el-table-column show-overflow-tooltip prop="name" label="姓名"></el-table-column>
                  <el-table-column show-overflow-tooltip prop="departmentName" label="部门"></el-table-column>
                  <el-table-column show-overflow-tooltip prop="telephone" label="电话"></el-table-column>
                  <el-table-column show-overflow-tooltip prop="mailbox" label="邮箱"></el-table-column>
              ...
              <el-tab-pane :label="towUser" name="fourth">
                ...
                >
                  <el-table-column show-overflow-tooltip type="selection" align="center"></el-table-column>
                  <el-table-column show-overflow-tooltip type="index" label="序号" width="80px" align="center"></el-table-column>
                  <el-table-column show-overflow-tooltip prop="assets_number" label="资产编号" width="180px" align="center"></el-table-column>
                  <el-table-column show-overflow-tooltip prop="assetsTypeName" label="配置项类型"></el-table-column>
                  <el-table-column show-overflow-tooltip prop="childAssetName" label="配置子类"  width="120px" align="center"></el-table-column>
                  <el-table-column show-overflow-tooltip prop="assets_name" label="资产名称"  width="120px" align="center"></el-table-column>
                  <el-table-column show-overflow-tooltip prop="deptName" label="部门"  width="120px" align="center"></el-table-column
                  ><el-table-column show-overflow-tooltip prop="receiverName" label="领用人"  width="120px" align="center"></el-table-column>
                  <el-table-column show-overflow-tooltip prop="purchaseCompanyName" label="购置公司"  width="120px" align="center"></el-table-column>
                  <el-table-column show-overflow-tooltip prop="is_secrecy" label="保密" sortable align="center">
                  ...
                  <el-table-column show-overflow-tooltip prop="assetsStatusName" label="资产状态" sortable align="center">
                    <template #default="scope">
                      <el-tag size="mini" icon="el-icon-delete" class="red" type="success">{{ scope.row.assetsStatusName }}</el-tag>
                    </template>
                  </el-table-column>
                  <el-table-column show-overflow-tooltip prop="itStatusName" label="IT状态" sortable align="center"></el-table-column>
                </el-table>
                <div style="margin-top: 10px">
              ...
              <el-tab-pane :label="fourUser" name="six">
                <el-table
                  ...
                  <el-table-column show-overflow-tooltip type="selection" align="center"></el-table-column>
                  <el-table-column show-overflow-tooltip type="index" label="序号" width="80px" align="center"></el-table-column>
                  <el-table-column show-overflow-tooltip sortable prop="code" label="问题单号" align="center"></el-table-column>
                  <el-table-column show-overflow-tooltip prop="title" sortable label="标题" align="center"></el-table-column>
        ...
        <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
          <el-card shadow="never" class="hasiscoll">
            <div class="box_card">
              ...
              <div class="box_content">
                <el-form-item label="编号:" class="mb0">{{ form.id }}</el-form-item>
                <el-form-item label="状态:" class="mb0">{{ form.statusName }}</el-form-item>
                <el-form-item label="服务群组:" class="mb0">{{ form.service_name }}</el-form-item>
                ...
                <el-form-item label="报障类别:" class="mb0">职场1-办公设备</el-form-item>
                <el-form-item label="重开次数:" class="mb0">{{ form.numberOfRestarts }}</el-form-item>
                <el-form-item label="影响可用性:" class="custemitem mb0">{{ form.is_effect == 0? '否' : '是' }}</el-form-item>
              </div>
            </div>
            <div class="box_card">
              ...
              <div class="box_content">
                ...
                <el-form-item label="公司:" class="mb0">鼎驰科技有限公司</el-form-item>
            ...
            <div class="box_card">
              ...
              <div class="box_content step_content">
                <el-steps direction="vertical" :active="2" space="40px">
                  <el-step title="开单" :description="form.create_time"></el-step>
                  <el-step title="响应" description=""></el-step>
      ...
      <div class="bottom">
        <el-button type="primary" size="medium" @click="save">指派</el-button>
        <dialogtwo ref="dialogtwo" @categoryData="deptset4" @fetch-data=" { gongdanclass }"></dialogtwo>
      </div>
    </el-form>

    <dialogfour ref="dialogfour" @userData="deptset2" @fetch-data=" { contactpeople }"></dialogfour>
    <XieChaRen ref="XieChaRen" @listData="getPeopleData" @fetch-data=" { input2 }"></XieChaRen>
    <assetsManagesDialog ref="assetsManagesDialog" @listData="listAssetsManages" @fetch-data=" { input2 }"></assetsManagesDialog>
...
<script>
  ...
  import {getAllManageInfo} from '@/api/eventAllManage'
  import {slaEventImpactUrgentGetFirst, urgencyGetAllList} from "@/api/affect";

  import Dialogtwo from '@/components/gongdanclass'
  import {designate} from '@/api/event'
  ...
  export default {
    ...
    methods: {
      //根据服务群组得到处理人
      serviceGroupsChange(){
        if(this.form.service_groups_id != null && this.form.service_groups_id != undefined && this.form.service_groups_id != ''){
          info(this.form.service_groups_id).then((res) => {
            if (res.code == 0) {
              if (res.data.eventServiceManage.is_assign_automatic == 1) {
      ...
      handleRemoveHandle(file, fileList) {
        this.clfileManageHandleList = fileList;
      ...
      async getData() {
        ...
        if (this.form.files1) {
          this.form.files1.forEach((x) => {
            this.fileManageHandleList1.push({name: x.file_name, url: x.id})
          })
        }
        this.userHistoryListClick();
        this.getFirst();
      ...
      async getUrgencyDegreeMap() {
        ...
        urgencyGetAllList({}).then((res) => {
          if (res.code == 0) {
            this.urgencyDegreeList = res.data
          }
        })
      },
      async fetchData1() {
        const {data} = await getAllManageInfo({"isAll":"2"});
        this.list = data;
      },
      async save() {
        // 定义任务flag
        ...
        if (this.form.service_groups_id != null && this.form.service_groups_id != undefined && this.form.service_groups_id != '') {
          // 判断处理人是否为空
          if (this.form.handler == null || this.form.handler == undefined || this.form.handler == '') {
            taskFlag = true;
          }
        }
        if (taskFlag){
          info(this.form.service_groups_id).then(res => {
            if (res.code == 0) {
              ...
              if (auto_engineer != null && auto_engineer != undefined && auto_engineer != '') {
