      ...
      <div class="hiddenmoretop" v-if="isShow">
        <el-row :gutter="20">
          ...
          <el-col :xs="24" :sm="24" :md="3" :lg="3" :xl="3">
            <el-form-item>
              <el-input
                ...
                placeholder="解决工程师"
                clearable
                @click.native="handleSolveUser"
              >
                <!--<el-button-->
                  <!--slot="append"-->
                  <!--icon="el-icon-search"-->
                  <!--@click="handleSolveUser"-->
                <!--&gt;</el-button>-->
              </el-input>
            </el-form-item>
          </el-col>
          <el-col :xs="24" :sm="24" :md="3" :lg="3" :xl="3">
            <el-form-item>
              <el-input
                v-model.trim="queryForm.handler_name"
                placeholder="处理人/关单人"
                clearable
                @click.native="handleHandlerUser1"
              >
                <!--<el-button-->
                  <!--slot="append"-->
                  <!--icon="el-icon-search"-->
                  <!--@click="handleHandlerUser1"-->
                <!--&gt;</el-button>-->
              </el-input>
            </el-form-item>
          </el-col>
          <el-col :xs="24" :sm="24" :md="3" :lg="3" :xl="3">
            <el-form-item>
              <el-input
                v-model.trim="queryForm.response_user_name"
                placeholder="响应人"
                clearable
                @click.native="handleResponseUser"
              >
                <!--<el-button-->
                  <!--slot="append"-->
                  <!--icon="el-icon-search"-->
                  <!--@click="handleResponseUser"-->
                <!--&gt;</el-button>-->
              </el-input>
            </el-form-item>
          </el-col>
          <el-col :xs="24" :sm="24" :md="3" :lg="3" :xl="3">
            <el-form-item>
              <el-input
                v-model.trim="queryForm.service_groups_name"
                placeholder="服务群组"
                clearable
                @click.native="handlegroup"
              >
                <!--<el-button-->
                  <!--slot="append"-->
                  <!--icon="el-icon-search"-->
        ...
        <el-row :gutter="20">
          ...
          <el-col :xs="24" :sm="24" :md="3" :lg="3" :xl="3">
            <el-select v-model="queryForm.request_type" placeholder="请求类型" class="w" clearable>
              <el-option v-for="(item,index) in requestTypeMapList" :key="index" :label="item.request_type_name"
                         :value="item.id"></el-option>
            </el-select>
          </el-col>
          <el-col :xs="24" :sm="24" :md="3" :lg="3" :xl="3">
          ...
          <el-col :xs="24" :sm="24" :md="3" :lg="3" :xl="3">
            <el-form-item>
              <el-select
                ...
                clearable
              >
                <el-option v-for="(item,index) in firstList" :key="index" :label="item.first_name"
                           :value="item.id"></el-option>
              </el-select>
            </el-form-item>
          </el-col>
          <el-col :xs="24" :sm="24" :md="3" :lg="3" :xl="3">
            <el-form-item>
              <el-select
                v-model="queryForm.event_satisfaction"
                placeholder="用户满意度"
                class="w"
                clearable
              >
          ...
          <el-col :xs="24" :sm="24" :md="3" :lg="3" :xl="3">
            <el-form-item>
              <el-input
                v-model.trim="queryForm.programme_type_name"
                placeholder="方案分类"
                clearable
                @click.native="handleProgramme"
              >
                <!--<el-button-->
                  <!--slot="append"-->
                  <!--icon="el-icon-search"-->
          ...
          <el-col :xs="24" :sm="24" :md="3" :lg="3" :xl="3">
            <el-form-item>
              <el-select
                v-model="queryForm.meetResponseSLA"
                placeholder="符合响应SLA"
                class="w"
                clearable
              >
...
<!--            <el-form-item>-->
<!--              <el-date-picker-->
<!--                v-model="queryForm.closeStartTime"-->
<!--                type="date"-->
...
<!--            <el-form-item>-->
<!--              <el-date-picker-->
<!--                v-model="queryForm.closeEndTime"-->
<!--                type="date"-->
...
<!--          </el-col>-->
          <el-col :xs="24" :sm="24" :md="3" :lg="3" :xl="3">
            <el-form-item>
              <el-select v-model="queryForm.solve_type" placeholder="解决方式" clearable>
                <el-option v-for="(item,index) in typeList" :key="index" :label="item.solution_name"
                           :value="item.id"></el-option>
              </el-select>
            </el-form-item>
          </el-col>
          <el-col :xs="24" :sm="24" :md="3" :lg="3" :xl="3">
            <el-form-item>
              <el-input
                v-model.trim="queryForm.expenses_start"
                type="number"
                placeholder="费用（从）"
                clearable
              />
          ...
          <el-col :xs="24" :sm="24" :md="3" :lg="3" :xl="3">
            <el-form-item>
              <el-input
                v-model.trim="queryForm.expenses_end"
                type="number"
                placeholder="费用（到）"
                clearable
              />
      ...
      <vab-query-form>
        ...
        <vab-query-form-right-panel :span="16">
          <el-form-item>
            <el-date-picker v-model="queryForm.billStartTime" placeholder="开单时间(Start)" type="date" clearable></el-date-picker>
          </el-form-item>
          <el-form-item>
            <el-date-picker v-model="queryForm.billEndTime" placeholder="开单时间(End)" type="date" clearable></el-date-picker>
          </el-form-item>
          <el-form-item>
            <el-input
