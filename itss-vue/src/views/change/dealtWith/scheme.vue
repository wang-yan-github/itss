<template>
  <div class="main-container pb80">
    <el-form ref="form" :model="form" :rules="rules" label-width="130px">
              ...
              <el-tab-pane label="属性" name="first">
                <div class="box_card">
                  ...
                  <div class="box_content">
                    ...
                    <el-form-item label="附件:" v-if="this.form.fileManageInfoList.length > 0">
                ...
                <div class="box_card">
                  <div class="box_header">方案待审核通知</div>
                  <div class="box_content">
                    <el-row :gutter="20">
      ...
      <div class="bottom">
        <el-button type="primary" size="medium" @click="save(0)">
          保存
        </el-button>
        <el-button type="warning" size="medium" @click="save(1)">
          完成方案
        </el-button>
        <!-- <el-dropdown
          trigger="click"
      ...
      save(status) {
        this.$refs['form'].validate(async (valid) => {
          ...
          if (valid) {
            ...
            toProgramme(this.form).then((res) => {
              if (res.code == 0) {
                this.$baseMessage('方案制定成功', 'success')
                this.$store.dispatch('tabsBar/delRoute', this.$route)
                this.$router.push({
