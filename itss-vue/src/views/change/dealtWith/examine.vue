          ...
          <el-card shadow="never">
            <el-tabs v-model="activeName" type="card">
              <el-tab-pane label="属性" name="first">
                    ...
                    <el-row :gutter="20">
                      <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                        <el-form-item label="审批人:">
                          {{ this.form.approve_name }}
                        </el-form-item>
                      </el-col>
                      <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                        <el-form-item label="审批意见:" prop="changeNode.approve_remark">
                          <vab-quill
                            v-model="form.changeNode.approve_remark"
                            :min-height="200"
                            :options="options"
                          ></vab-quill>
                          <p class="ts">
                ...
                <div class="box_card">
                  <div class="box_header">审批完成通知</div>
                  <div class="box_content">
                    <el-row :gutter="20">
  ...
  export default {
    ...
    data() {
      return {
        ...
        timeStatus: 0,
        rules: {
          'changeNode.approve_remark': [
            {required: true, trigger: 'blur', message: '请输入审批意见'},
          ]
