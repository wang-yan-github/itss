          ...
          <el-card shadow="never">
            <el-tabs v-model="activeName" type="card">
              <el-tab-pane label="属性" name="first">
                    ...
                    <el-row :gutter="20">
                      ...
                      <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                        <el-form-item label="实施备注:">
                          <div class="ql-editor content-detail" v-html=" form.changeImplement.implement_remark"></div>
                        </el-form-item>
                      </el-col>
                ...
                <div class="box_card">
                  <div class="box_header">实施后评审</div>
                  <div class="box_content">
                    <el-row :gutter="20">
                      <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                        <el-form-item label="实施后评审意见:" prop="changeImplementApprove.after_implement_remark">
                          <quill-editor
                            ref="myQuillEditor1"
                            v-model="form.changeImplementApprove.after_implement_remark"
                            :min-height="200"
                            :options="options"
                          ></quill-editor>
                          <p class="ts">
                      ...
                      <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                        <el-form-item label="后续流程:">
                          <el-select v-model="form.content" placeholder="请选择" clearable>
                            <el-option label="创建配置请求" value="peizhi" v-permission="pzgl_overview"></el-option>
                            <el-option label="创建发布" value="fabu"></el-option>
                          </el-select>
                        </el-form-item>
                      </el-col>
  ...
  export default {
    ...
    data() {
      return {
        ...
        rules: {
          'changeImplementApprove.after_implement_remark': [
            {required: true, trigger: 'blur', message: '请输入实施后评审意见'},
          ]
        },
    ...
    methods: {
      ...
      save() {
        this.$refs['form'].validate(async (valid) => {
          ...
          if (valid) {
            this.form.changeImplementApprove.status = status;
            this.form.changeNode.approve_status = status;
            toImplementApprove(this.form).then((res) => {
              if (res.code == 0) {
                this.$baseMessage('实施后评审成功', 'success')
                this.$store.dispatch('tabsBar/delRoute', this.$route)
                if (this.form.content == "fabu") {
                  //添加发布
                  this.$router.push({
                    path: '/biangeng/createPublish',
                    query: {changeInfo: this.form},
                  })
                } else if (this.form.content == "peizhi") {
                  //添加配置
                  this.$router.push({
                    path: '/pzgl/assetsConfigInfo',
                  })
                } else {
                  //变更待办
                  this.$router.push({
