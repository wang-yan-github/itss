          ...
          <el-card shadow="never">
            <el-tabs v-model="activeName" type="card">
              <el-tab-pane label="属性" name="first">
                ...
                <div class="box_card">
                  ...
                  <div class="box_content">
                    <el-row :gutter="20">
                      ...
                      <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                        <el-form-item label="方案审核意见:" prop="changeProgrammeApprove.approve_remark">
                          <quill-editor
                            ref="myQuillEditor1"
                            v-model="form.changeProgrammeApprove.approve_remark"
                            :min-height="200"
                            :options="options"
                          ></quill-editor>
                          <p class="ts">
                ...
                <div class="box_card">
                  <div class="box_header">方案评审通知</div>
                  <div class="box_content">
                    <el-row :gutter="20">
    ...
    data() {
      return {
        ...
        form: {
          ...
          changeProgrammeApprove: {approve_user: '', status: '', is_del: '0'},//方案评审
        ...
        selectRowsQuest: '',
        rules: {
          'changeProgrammeApprove.approve_remark': [
            {required: true, trigger: 'blur', message: '方案审核意见'},
          ],
      ...
      save(status) {
        this.$refs['form'].validate(async (valid) => {
          ...
          if (valid) {
            ...
            this.form.changeProgrammeApprove.status = status;


            toProgrammeApprove(this.form).then((res) => {
              if (res.code == 0) {
